...
public struct Files {
    ...
    // Creates the directory if needed. If created, marks the directory as excluded from (e.g., iCloud) backup.
    ...
    // If `excludeFromBackup` is true, and the directory is created, don't let these temporary files be backed up to iCloud-- Apple doesn't like this (e.g., when reviewing apps).
    public static func createDirectoryIfNeeded(_ directory: URL, excludeFromBackup: Bool = true) throws {
